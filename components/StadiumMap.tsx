...
import { pt, sectorPath, pctPos, cx, cy } from "@/lib/venue/geometry";
...
import { MapDefs, FieldLayer, GatesLayer, TransitLayer, SectionLayer, getStatusText } from "@/components/StadiumMapLayers";
      ...
      <TooltipProvider delay={50}>
        <div className={`relative flex flex-col items-center select-none bg-canvas ${className || ""}`}>
          ...
          */}
          ...
          >
            {/* 1. DEFS — route destination arrow markers (extracted to StadiumMapLayers) */}
            <MapDefs />
            ...
            {/* 3. SEATING SECTIONS LAYER (+ labels) — extracted to StadiumMapLayers */}
            <SectionLayer
            ...
            {/* 4. FIELD LAYER — §22.5 (extracted to StadiumMapLayers) */}
            <FieldLayer />

            {/* 5. GATE MARKERS LAYER — §22.3 (extracted to StadiumMapLayers) */}
            <GatesLayer gateStatus={gateStatus} onZoneClick={onZoneClick} />

            {/* 6. TRANSIT MARKERS LAYER — §22.3 (extracted to StadiumMapLayers) */}
            <TransitLayer onZoneClick={onZoneClick} />
